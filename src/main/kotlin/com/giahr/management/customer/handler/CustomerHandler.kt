package com.giahr.management.customer.handler

import com.giahr.management.customer.model.Customer
import com.giahr.management.customer.model.ErrorResponse
import com.giahr.management.customer.service.CustomerService
...
class CustomerHandler(val customerService: CustomerService) {
    ...
    fun create(serverRequest: ServerRequest) =
            customerService.createCustomer(serverRequest.bodyToMono()).flatMap {
                ...
                badRequest().body(fromValue(ErrorResponse("error creating customer", it.message
                        ?: "error")))
            }
